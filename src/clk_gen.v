...
//  /   /         Filename : clk_gen.v
// /___/   /\     Timestamp : 05/08/2013 10:30:22
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: xaw2verilog -intstyle D:/ddr2_fifo_module/ipcore_dir/clk_gen.xaw -st clk_gen.v
//Design Name: clk_gen
...
module clk_gen(CLKIN1_IN, 
   ...
   PLL_ADV #( .BANDWIDTH("OPTIMIZED"), .CLKIN1_PERIOD(20.000), 
         ...
         .CLKFBOUT_MULT(8), .CLKFBOUT_PHASE(0.0), .REF_JITTER(0.000000) ) 
